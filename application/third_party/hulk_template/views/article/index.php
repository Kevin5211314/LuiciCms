...
a:2:{s:14:"/article/index";i:1580792978;s:19:"base/parent_message";i:1578827846;}
*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<body>
    ...
    <script>
        layui.use(['form', 'table', 'layer', 'layuimini', 'echarts'], function () {
            var $ = layui.jquery,
                form = layui.form,
                table = layui.table;
                ...
                if (obj.event === 'edit') {
                    ...
                    layer.confirm('真的删除行么', function (index) {
                        $.ajax({
                             type: "POST",
                             url: "/articles/detele",
                             data: {id:data.id,"<?php echo $this->security->get_csrf_token_name();?>":"<?php echo $this->security->get_csrf_hash(); ?>"},
                             dataType: "json",
                             success: function(data){
                                if(data.code == 400){
                                    layer.msg(data.msg,{ time: 2000 }, function () {
