                ...
                <form class="layui-form">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="cid" lay-verify="cid" autocomplete="off" placeholder="请输入分类ID" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="image" autocomplete="off" placeholder="上传图片" class="layui-input" style="width: 88%;" value="" />
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="summary" lay-verify="summary" autocomplete="off" placeholder="请输入简介" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="photo" lay-verify="photo" autocomplete="off" placeholder="请输入相册" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="content" lay-verify="content" autocomplete="off" placeholder="请输入内容" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="view" lay-verify="view" autocomplete="off" placeholder="请输入点击量" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="keywords" lay-verify="keywords" autocomplete="off" placeholder="请输入关键字" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="fabulous" lay-verify="fabulous" autocomplete="off" placeholder="请输入点赞数" class="layui-input">
                        </div>
                    </div>

                    <input type="text" name="id" lay-verify="id" class="layui-input" style="display: none;" value="" />
                    <input type="text" class="layui-input" name="<?php echo $this->security->get_csrf_token_name(); ?>" style="display: none;" value="<?php echo $this->security->get_csrf_hash(); ?>">
