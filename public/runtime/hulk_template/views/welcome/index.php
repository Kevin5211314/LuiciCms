...
<body class="layui-layout-body layuimini-all">
        ...
        <div class="layui-header header">
            ...
            <ul class="layui-nav layui-layout-right">
                ...
                <li class="layui-nav-item layuimini-setting">
                    <a href="javascript:;"> <?php echo $_SESSION['admin_name'];?></a>
                    <dl class="layui-nav-child">
                        <dd>
                            <a href="javascript:;" data-iframe-tab="/welcome/setting.html" data-title="基本资料" data-icon="fa fa-gears">基本资料</a>
                        </dd>
                        <dd>
                            <a href="javascript:;" data-iframe-tab="/welcome/uppass.html" data-title="修改密码" data-icon="fa fa-gears">修改密码</a>
                        </dd>
                        <dd>
    ...
    <script src="/resource/lib/layui-v2.5.4/layui.js?v=1.0.4" charset="utf-8"></script>
